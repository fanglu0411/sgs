...
// class _CustomPointerScrollableState extends State<CustomPointerScrollable> with TickerProviderStateMixin implements ScrollContext {
...
//     }
//
//     _position = controller?.createScrollPosition(_physics, this, oldPosition) ?? ScrollPositionWithSingleContext(physics: _physics, context: this, oldPosition: oldPosition);
...
//     }
//
//     return _configuration.buildOverscrollIndicator(context, result, widget.);
//   }
//
//   @override
//   void debugFillProperties(DiagnosticPropertiesBuilder properties) {
