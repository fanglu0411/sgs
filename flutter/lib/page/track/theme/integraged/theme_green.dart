...
Map<String, dynamic> theme_green = {
  "ref_seq": {
    "light": {
  ...
  "gff": {
    "light": {
      "name": "Green-Light",
      "track_color": 4282493561,
      "track_height": 200,
      "max_height": {'enabled': true, 'value': 500},
      "feature_height": 8,
      "show_label": true,
      "label_font_size": 12,
      "label_color": Colors.black54,
      "feature_group_color": "79d8e4d9",
      "featureStyles": {
        "gene": {
          "name": "gene",
          "id": "gene",
  ...
  "eqtl": {
    ...
    "dark": {
      'track_height': 80.0,
      'track_max_height': {'enabled': true, 'value': 200.0},
      'track_color': Colors.greenAccent,
      'radius': 5,
      'custom_max_value': {'enabled': true, 'value': 0.05},
      'value_scale_type': 2,
    },
