...
mixin CollapsibleAnimationMixin<T extends StatefulWidget> on TickerProviderStateMixin<T> {
  ...
  void initState() {
    super.initState();
    expandController = AnimationController(duration: Duration(milliseconds: 400), vsync: this);
    expandCurve = CurvedAnimation(curve: Curves.easeInOutCubic, parent: expandController!);
    expandArrowAnimation = Tween<double>(begin: 0.75, end: 1.0).animate(expandCurve!);
    if (isExpanded) {
