...
class NumericExtents implements Extents<num> {
  ...
  bool overlaps(NumericExtents other) {
    return _containsValue(other.min) || _containsValue(other.max) || other._containsValue(min) || other._containsValue(max);
  }
  ...
  static const NumericExtents unbounded = const NumericExtents(double.negativeInfinity, double.infinity);
